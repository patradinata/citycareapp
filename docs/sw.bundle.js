...
(() => {
    ...
    async fetch(e) {
      ...
      try {
        ...
        if (e instanceof Error)
          throw new n('plugin-error-request-will-fetch', { thrownErrorMessage: e.message });
      }
      const a = r.clone();
      try {
        let e;
      ...
      const { cacheName: c, matchOptions: h } = this._strategy,
        ...
        d = u
          ? await (async function (e, t, r, n) {
              ...
              const a = Object.assign(Object.assign({}, n), { ignoreSearch: !0 }),
                i = await e.keys(t, a);
    ...
    async getCacheKey(e, t) {
      ...
      if (!this._cacheKeys[r]) {
        ...
        for (const e of this.iterateCallbacks('cacheKeyWillBeUsed'))
          n = y(await e({ mode: t, request: n, event: this.event, params: this.params }));
        this._cacheKeys[r] = n;
      }
  ...
  class w {
    ...
    async _awaitComplete(e, t, r, n) {
      ...
      try {
        (await t.runCallbacks('handlerDidRespond', { event: n, request: r, response: s }),
          await t.doneWaiting());
      } catch (e) {
  ...
  class m extends w {
    ...
    async _handleFetch(e, t) {
      ...
      if (!this._fallbackToNetwork)
        throw new n('missing-precache-entry', { cacheName: this.cacheName, url: e.url });
      {
        const n = s.integrity,
          a = e.integrity,
          i = !a || a === n;
        ((r = await t.fetch(new Request(e, { integrity: 'no-cors' !== e.mode ? a || n : void 0 }))),
          n &&
            i &&
            'no-cors' !== e.mode &&
            (this._useDefaultCacheabilityPluginIfNeeded(), await t.cachePut(e, r.clone())));
      }
      return r;
    }
    async _handleInstall(e, t) {
      ...
      if (!(await t.cachePut(e, r.clone())))
        throw new n('bad-precaching-response', { url: e.url, status: r.status });
      return r;
    }
    _useDefaultCacheabilityPluginIfNeeded() {
      ...
      for (const [r, n] of this.plugins.entries())
        n !== m.copyRedirectedCacheableResponsesPlugin &&
          (n === m.defaultPrecacheCacheabilityPlugin && (e = r), n.cacheWillUpdate && t++);
      0 === t
      ...
      for (const r of e) {
        ...
        if ('string' != typeof r && r.integrity) {
          if (
            ...
            throw new n('add-to-cache-list-conflicting-integrities', { url: s });
      ...
      return o(e, async () => {
        ...
        for (const [t, r] of this._urlsToCacheKeys) {
          const n = this._cacheKeysToIntegrities.get(r),
            ...
            a = new Request(t, { integrity: n, cache: s, credentials: 'same-origin' });
          await Promise.all(
            this.strategy.handleAll({ params: { cacheKey: r }, request: a, event: e }),
          );
        }
  ...
  class U {
      ...
      return (
        c instanceof Promise &&
          ...
          (c = c.catch(async (n) => {
            if (h)
              try {
                return await h.handle({ url: r, request: e, event: t, params: s });
              } catch (e) {
    ...
    unregisterRoute(e) {
      if (!this._routes.has(e.method))
        throw new n('unregister-route-but-not-found-with-method', { method: e.method });
  ...
  function q(e, t, r) {
    ...
    return (
      (k || ((k = new U()), k.addFetchListener(), k.addCacheListener()), k).registerRoute(s),
      s
    );
  }
  class T extends C {
  ...
  var K = 'https://citycare-api.dicoding.dev/v1';
  function O(e) {
    return (
      (O =
    ...
    function U(t, r, n) {
      ...
      return function (a, i) {
        ...
        for (n.method = a, n.arg = i; ; ) {
          ...
          'throw' === h.type && ((s = y), (n.method = 'throw'), (n.arg = h.arg));
        }
      };
    }
    function k(t, r) {
  ...
  var M,
    W = [
      { revision: null, url: '22c88b4abb7e3ccf0c99.png' },
      ...
      { revision: '1439dc5d1b2f5e7bde762f4d631acf86', url: '756.bundle.js' },
      { revision: null, url: '8f2c4d11474275fbc161.png' },
      { revision: null, url: 'a0c6cc1401c107b501ef.png' },
      { revision: 'a456f81150c129eea8a96590d989c424', url: 'app.bundle.js' },
      { revision: '02b30a124d6d1bf13bfdc096f2b62c6e', url: 'app.bundle.js.LICENSE.txt' },
      { revision: 'c02251747b0308d59752cf0886e21b8e', url: 'app.css' },
      { revision: '241f93ccb0b56dcc3eca132bcb7bd2ee', url: 'app.webmanifest' },
      { revision: '738a1acc16f604958f8d1828caf7bc0a', url: 'favicon.png' },
      { revision: '746d24348cfb904a349bb8bbeff5c407', url: 'images/icons/add-x192.png' },
      { revision: '737ec290471f789e58b8e1e10cd45789', url: 'images/icons/add-x512.png' },
      { revision: 'ed90b65db47d46edc6b6c476d88ed0ec', url: 'images/icons/bookmark-x192.png' },
      { revision: '405929716762e708c6a309d74f86cd3e', url: 'images/icons/bookmark-x512.png' },
      { revision: '7620c0b5d761d87557ac9d953110149d', url: 'images/icons/icon-x144.png' },
      { revision: 'f9a53f892e4e78a6a9029c7f7964d707', url: 'images/icons/icon-x192.png' },
      { revision: '64e19602514e4ab5b056e4d14fcbf784', url: 'images/icons/icon-x48.png' },
      { revision: '96db8052367fe066b1a45e7f19154395', url: 'images/icons/icon-x512.png' },
      { revision: '86f46ceb587cdc3eff8873af5066abd7', url: 'images/icons/icon-x72.png' },
      { revision: '9be2a14f4ed00375ebfbc366797f3edc', url: 'images/icons/icon-x96.png' },
      { revision: 'bd2d5c068180adb417a724d09a1f9b18', url: 'images/icons/maskable-icon-x128.png' },
      { revision: '3dee6cf44ec2d43fcfe0029d4e2d5ecc', url: 'images/icons/maskable-icon-x192.png' },
      { revision: '48b86060c8a83885c306774b1a718e7b', url: 'images/icons/maskable-icon-x384.png' },
      { revision: 'b31b16e52598fb8c83d9b12eeb485c16', url: 'images/icons/maskable-icon-x48.png' },
      { revision: 'd4572ceb2b840f4a134b6d6c116333a4', url: 'images/icons/maskable-icon-x512.png' },
      { revision: 'd4ddafd6d83dc5fba843311973e1da02', url: 'images/icons/maskable-icon-x72.png' },
      { revision: '9733bf3167d55e92900040209e32ca14', url: 'images/icons/maskable-icon-x96.png' },
      { revision: 'ff95af96068df9ea363735a626468a94', url: 'images/logo.png' },
      { revision: '8cafb30ad735a75404115e1d68fae087', url: 'images/orange-background.png' },
      { revision: '7ca016b4bd62f941b89e40f796aeac56', url: 'images/placeholder-image.jpg' },
      {
        revision: '4862fada5ecd2d3753781006035ecc19',
        url: 'images/screenshots/CityCareApp_001.png',
      },
      {
        revision: '2337572a512752903c13fd3230b21d42',
        url: 'images/screenshots/CityCareApp_002.png',
      },
      {
        revision: 'e2101bed01a329c388b2098c4bde2e3a',
        url: 'images/screenshots/CityCareApp_003.png',
      },
      {
        revision: 'f14bfb864071ffe39587429e11e6fbdf',
        url: 'images/screenshots/CityCareApp_004.png',
      },
      {
        revision: '221fa5d398e6e8a6e003537c0d4759e1',
        url: 'images/screenshots/CityCareApp_005.png',
      },
      {
        revision: 'e1bc29d5f4b935666cf57a13a4f87225',
        url: 'images/screenshots/CityCareApp_006.png',
      },
      { revision: 'e0f43f2a57d79f54d143fa3bc46df7ac', url: 'index.html' },
      { revision: '4e0e34f265fae8f33b01b27ae29d9d6f', url: 'sw.bundle.js.LICENSE.txt' },
    ];
  ((M = W),
    R().precache(M),
    (function (e) {
    ...
    q(
      function (e) {
        var t = e.url;
        return (
          'https://fonts.googleapis.com' === t.origin || 'https://fonts.gstatic.com' === t.origin
        );
      },
    ...
    q(
      function (e) {
        var t = e.url;
        return 'https://cdnjs.cloudflare.com' === t.origin || t.origin.includes('fontawesome');
      },
    ...
    q(
      function (e) {
        var t = e.request,
          r = e.url;
        return new URL(K).origin === r.origin && 'image' !== t.destination;
      },
      new (class extends w {
        constructor(e = {}) {
          (super(e),
        ...
        async _handle(e, t) {
          ...
          const i = this._getNetworkPromise({ timeoutId: a, request: e, logs: r, handler: t });
          s.push(i);
        ...
        async _getNetworkPromise({ timeoutId: e, request: t, logs: r, handler: n }) {
          ...
          return (e && clearTimeout(e), (!s && a) || (a = await n.cacheMatch(t)), a);
        }
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 2:
                    return (
                      (r = t.sent),
                      (t.next = 5),
                      self.registration.showNotification(r.title, { body: r.options.body })
                    );
                  case 5:
                  case 'end':
                    return t.stop();
